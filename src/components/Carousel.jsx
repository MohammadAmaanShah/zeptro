...
const Carousel = () => {
    ...
    const SamplePrevArrow = (props) => {
        ...
        return (
            ...
            <div className={`arrow ${className}`} onClick={onClick} style={{ zIndex: 3 }}>
                <AiOutlineArrowLeft className='arrows ' style={{ ...style, display: 'block', borderRadius: '50px', color: 'white', position: 'absolute', padding: '2px', left: '50px', background: '#f53347' }} />
            </div>
        )
    ...
    const SampleNextArrow = (props) => {
        ...
        return (
            <div className={`arrow ${className}`} onClick={onClick} style={{ zIndex: 3 }}>
                <AiOutlineArrowRight className='arrows ' style={{ ...style, display: 'block', borderRadius: '50px', color: 'white', position: 'absolute', padding: '2px', right: '50px', background: '#f53347' }} />
            </div>
        )
                            ...
                            return <div key={index} className='bg-linear-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] -z-10 '>
                                <div className='flex  md:flex-row flex-col gap-10 justify-center items-center px-4 min-h-[470px] py-7'>
                                    <div className='space-y-6'>
                                        ...
                                        <button className='bg-linear-to-r from-purple-500 to-red-500 py-3 px-5 cursor-pointer mt-2 rounded-md'>Shop Now </button>
                                    </div>
                                    <div>
